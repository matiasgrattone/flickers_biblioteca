...
Public Class buscarlibro
        ...
        If bandera = 1 Then
            Try
                ...
                Try
                    ...
                    dgvlibros.Columns(7).Width = 100
                    dgvlibros.Columns(8).Width = 100
    ...
    Private Sub Timer2_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles timerautor.Tick
