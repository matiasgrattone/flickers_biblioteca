Public Class ingresolibro
                        ...
                        Else
                            Try
                                ...
                                If cmbsala.SelectedItem = "No" Then
                                    Consulta = "insert into libro values('" + txtcod_libro.Text + "',concat(upper(left('" + txttitulo.Text + "',1)),lower(substr('" + txttitulo.Text + "',2))), concat(upper(left('" & autor & "',1)),lower(substr('" & autor & "',2))), concat(upper(left('" & editorial & "',1)),lower(substr('" & editorial & "',2))),'" + txtvolumen.Text + "','" + txtanio.Text + "', concat(upper(left('" + txtorigen.Text + "',1)),lower(substr('" + txtorigen.Text + "',2))), concat(upper(left('" + txtobservaciones.Text + "' ,1)),lower(substr('" + txtobservaciones.Text + "' ,2))),'0', concat(upper(left('" & clasificacion & "',1)),lower(substr('" & clasificacion & "',2))),concat(upper(left('" + txtubicacion.Text + "',1)),lower(substr('" + txtubicacion.Text + "',2))),'0','" + Date.Now.ToString("yyyy-MM-dd") + "')"
                                    consultar()
    ...
    Private Sub ingresolibro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'Comprobacion sobre si la base de datos se encuentra ON'
        ...
        If bandera = 1 Then
            ...
            'Datos utilizados para modificar el tamaño de los datagrids mediante el timer'
            ...
            Try
                ...
                If errorau = 0 Then
                    ...
                    Else
                        ...
                        txtpaisau.Clear()
                        timerautor.Enabled = True
                        'Reinciamos la variable para confirmar si hay errores y desactivamos los errorprovider'
                        primeringresoau = 0
