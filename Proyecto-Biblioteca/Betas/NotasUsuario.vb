Public Class NotasUsuario
    ...
    Private Sub GuardarComoToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GuardarComoToolStripMenuItem.Click
        ...
        Else
            ...
            Consulta = "INSERT INTO notas (NombreNota, texto, cedula, fecha) VALUES ( '" + NombreDelArchivo.ToString + "', '" + UbicacionParaLaBaseDeDatos.ToString + "', '" + MENU3.lbl_cedula.Text + "','" + Date.Now.ToString("yyyy-MM-dd") + "')"
            consultar()
            ActualizarNotas()
        End If
